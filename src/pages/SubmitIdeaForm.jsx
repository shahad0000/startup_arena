...
export default function SubmitIdeaForm() {
  ...
  <div className="w-full max-w-5xl p-6 ">
    ...
    <div className="text-center mb-6">
      <p className="text-3xl md:text-4xl font-bold mb-3">Draw Your Startup Idea</p>
      <p className="text-sm md:text-base font-medium text-gray-500">
        Share your innovative idea with our community and get valuable feedback from potential investors.
      </p>
    </div>
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block font-semibold text-sm mb-1">MVP/Demo Link</label>
          <input
            type="text"
            name="mvpLink"
