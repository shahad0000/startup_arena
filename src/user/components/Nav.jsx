...
function Nav() {
  ...
  return (
    <>
      ...
      <Disclosure
        as="nav"
        className="bg-white border-b border-blue-900  "
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
                    ...
                    <Link
                      ...
                      className={classNames(
                        isActive
                          ...
                          : "text-gray-800 hover:underline hover:text-blue-900",
                        "rounded-md px-3 py-2 text-sm font-medium transition transform duration-300 ease-in-out hover:scale-103 hover:shadow-2xl"
                      )}
                    >
                      {item.name}
                    </Link>
            ...
            <div className="sm:hidden flex items-center">
              <DisclosureButton className="group inline-flex items-center justify-center rounded-md p-2 text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-900">
                ...
                <Link
                  ...
                  className={classNames(
                    isActive
                      ...
                      : "text-gray-800 hover:bg-gray-200 hover:text-blue-900",
      ...
      {showProfile && (
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center">
          <div className="relative">
            <button
              className="absolute -top-4 -right-4 bg-white text-blue-900 rounded-full p-1 shadow"
